...
This example illustrates Iceoryx2's robust publisher-subscriber messaging pattern
between two separate processes through uProtocols UTransport trait. The publisher sends a message every second,
